...
import com.example.nftcam.filter.jwt.JwtAuthenticationFilter;
import com.example.nftcam.filter.jwt.JwtExceptionFilter;
import com.example.nftcam.filter.jwt.JwtTokenUtil;
import com.example.nftcam.filter.logging.LoggingFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception{
        ...
        return httpSecurity
                ...
                .antMatchers("/profile", "/api/auth/login","/api/material/convertion").permitAll()
