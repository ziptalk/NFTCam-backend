...
public class MaterialAsyncService {
    ...
    public void publishEvent(Long materialId, String hash, ChainType chainType) {
//        log.info("async publishEvent hash : {}", hash);
        eventPublisher.publishEvent(new MintingCompletedEvent(hash, materialId, chainType));
    }
}
